...
void showUsage() {
    cout << "Usage: kpi [-w writeOption] [-i serverIp] [-p port] [-t period] [--all] [--debug] [--phy]" << endl << endl;
    ...
    cout << "-d : The directory for kpi file saved to, default is the directory where executing kpi" << endl;
...
void showMinorUsage() {
    cout << "Usage: kpi [-w writeOption] [-d directory] [-t period] [--all] [--debug] [--phy]" << endl << endl;
...
void parseMinorOptions(string option, string value) {
    if (option.compare("-w") == 0) {
        gWriteOption = Util::s2i(value);
        cout << "gWriteOption = " << gWriteOption << endl;
    } else if (option.compare("-t") == 0) {
