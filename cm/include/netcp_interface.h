...
/* define LTE series */
#define TD_LTE_FEMTO		2
#define TD_LTE_UNIFY		3
#define FDD_LTE			4

#define LTE_IB_WAS	TD_LTE_FEMTO
//#define LTE_IB_WAS	TD_LTE_UNIFY
//#define LTE_IB_WAS	FDD_LTE
...
typedef enum
{
     	...
     	OAM_RECS_L1_CFG_REPLY,
     	OAM_RECS_L1_LOG,
     	OAM_RECS_L2_CFG_REPLY,
     	OAM_RECS_L2_LOG,
     	OAM_RECS_S1_DSP_CFG_REPLY,
     	OAM_RECS_S1_DSP_LOG,

     	OAM_RECS_L1_CFG_REPLY_CYCLE,   
     	OAM_RECS_L1_LOG_CYCLE,                
     	OAM_RECS_L2_CFG_REPLY_CYCLE,    
     	OAM_RECS_L2_LOG_CYCLE,               
     	OAM_RECS_S1_DSP_CFG_REPLY_CYCLE,    
     	OAM_RECS_S1_DSP_LOG_CYCLE,     
     	...
     	S1_ARM_RECS_L2_CYCLE,
     	S1_ARM_RECS_S1_DSP_CYCLE,
...
{
	TX_L2_TO_L1_CONFIG,
	TX_L2_TO_L1_DATADOWN,
	TX_L2_TO_L3_DATAUP_OR_CONFIG,
	TX_L2_TO_S1_DSP_DATA,
	TX_L2_TO_S1_ARM_DATA,
	TX_L2_TO_OAM_DATAUP_OR_REPLY
}Qmss_L2_TranType;
/* QMSS L2接收队列类型枚举 */
typedef enum
{
	 RX_L2_FROM_L1_CQIUP,
	 RX_L2_FROM_L1_DATAUP,
	 RX_L2_FROM_L3_DATAUP_OR_CONFIG,
	 RX_L2_FROM_S1_DSP_DATA,
	 RX_L2_FROM_S1_ARM_DATA,
...
typedef enum
{
	TX_L3_TO_L1_CONFIG_OR_REPLY,
	TX_L3_TO_L2_CONFIG_OR_REPLY
}Qmss_L3_TranType;
/* QMSS L3接收队列类型枚举 */
typedef enum
{
	 RX_L3_FROM_L1_CONFIG,
	 RX_L3_FROM_L2_CONFIG
}Qmss_L3_RecvType;
/////////////////////////////////////////////S1_DSP对列类型////////////////////////////////////////
/* QMSS S1_DSP发送空闲队列类型枚举 */
typedef enum
{
	TX_S1_DSP_TO_L2_DATA,
	TX_S1_DSP_TO_S1_ARM_DATA,
	TX_S1_DSP_TO_OAM_DATA
}Qmss_S1_DSP_TranType;

/* QMSS S1_DSP接收队列类型枚举 */
typedef enum
{
	 RX_S1_DSP_FROM_L2_DATA,
	 RX_S1_DSP_FROM_S1_ARM_DATA,
	 RX_S1_DSP_FROM_OAM_DATA
}Qmss_S1_DSP_RecvType;
/////////////////////////////////////////////////S1_ARM对列类型///////////////////////////////////////////
/* QMSS S1_ARM发送空闲队列类型枚举 */
typedef enum
{
	TX_S1_ARM_TO_L2_DATA,
	TX_S1_ARM_TO_S1_DSP_DATA
}Qmss_S1_ARM_TranType;
/* QMSS S1_ARM接收队列类型枚举 */
typedef enum
{
	RX_S1_ARM_FROM_L2_DATA,
	RX_S1_ARM_FROM_S1_DSP_DATA
}Qmss_S1_ARM_RecvType;
/////////////////////////////////////////////////OAM对列类型///////////////////////////////////////////
/* QMSS OAM发送空闲队列类型枚举 */
typedef enum
{
	TX_OAM_TO_L1_CONFIG,
	TX_OAM_TO_L2_CONFIG,
	TX_OAM_TO_S1_DSP_CONFIG
}Qmss_OAM_TranType;
/* QMSS OAM接收队列类型枚举 */
typedef enum
{
	RX_OAM_FROM_L1_CONFIG_REPLY,
 	RX_OAM_FROM_L1_LOG,
 	RX_OAM_FROM_L2_CONFIG_REPLY,
 	RX_OAM_FROM_L2_LOG,
 	RX_OAM_FROM_S1_DSP_CONFIG_REPLY,
 	RX_OAM_FROM_S1_DSP_LOG
}Qmss_OAM_RecvType;
...
//     	OAM_RECS_L2_CFG_REPLY,
//     	OAM_RECS_L2_LOG,
//     	OAM_RECS_CMAC_CFG_REPLY,
//     	OAM_RECS_CMAC_LOG,
//     
//     	/*  L3  */
//     	L3_SEND_L2_CFG_REQUEST,
//     	L3_SEND_CMAC_CFG_REQUEST,
//
//     	L3_RECS_L2_CFG_REPLY,
//     	L3_RECS_CMAC_CFG_REPLY,
//
//	/* CMAC */
//	CMAC_SEND_L1_DCI,
//	CMAC_SEND_L1_CFG,
...
#if 0 //(LTE_IB_WAS == TD_LTE_FEMTO)    /* 企业级需要由ARM驱动提供PA接口 */
extern int Pa_SetMacs(paEthInfo_t *ethInfo, paRouteInfo_t *routeInfo, paRouteInfo_t *nfailInfo, int index);
extern int Pa_SetIps(paIpInfo_t *ipInfo, int macLink, paRouteInfo_t *routeInfo, paRouteInfo_t *nfailInfo,int index);
extern int Pa_SetIpsToPdsp2(paIpInfo_t *ipInfo, int ipLink, paRouteInfo_t *routeInfo, paRouteInfo_t *nfailInfo,int index);
extern int Pa_SetOuterIps(paIpInfo_t *ipInfo, int macLink, paRouteInfo_t *routeInfo, paRouteInfo_t *nfailInfo,int index, Sa_ChanRxSwInfo_t saChanSwInfo);
extern int Pa_SetGtpu(uint32_t teid, int ipLink, paRouteInfo_t *routeInfo, int index);
extern int Pa_NatEnableConfig(void);
extern int Pa_ExtraRule(void);
extern int Pa_ExtraRuleIpsec(void);
extern int Pa_DelL2L3Handle(uint8_t L2OrL3, uint32_t handle);
extern int Pa_DelL4Index(int index);
extern int Pa_GetFreeQue(void);
extern int Pa_FreeQue(Qmss_QueueHnd queue);
extern int Pa_SendArp(void);

extern int 	Pa_SendPkt(unsigned char *pkt, uint32_t pkt_len, uint32_t queue);
extern int 	Pa_GetPaStats(void);
extern int Pa_SetPorts(uint16_t ports, int ipLink, paRouteInfo_t *routeInfo, int index);
#endif
